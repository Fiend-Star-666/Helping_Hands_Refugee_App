    ...
    return (
        <div className="card col-md-4 offset-md-3 my-5 " style={{backgroundColor: 'lavenderblush', margin: 'auto'}}>
            ...
            <div className='form-group'>
                <input type="email" placeholder="someone@email.com" name="email" onChange={handleEmailChange}
                       value={email}/>
            </div>
            ...
            <div className='form-group'>
                <input type="text" placeholder="Driver Licence" name="driverLicense" onChange={handleLicenseChange}
                       value={driverLicense}/>
            </div>

            <label>Enter New Password:</label>
            <div className='form-group'>
                <input type="password" placeholder="new password" name="password" onChange={handlePasswordChange}
                       value={password}/>
            </div>
