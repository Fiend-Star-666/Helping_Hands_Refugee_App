                ...
                <Container id="hero" className="text-center">
                    <Row>
                        <Col className="hero-content d-inline-block m-4">
                            ...
                            <p>We're on a world wide mission to help Ukraine refugees in need. Small or big, you can
                                show your caring by lending a helping hand.</p>
                            <button className="button">Join Today</button>
                        </Col>
                        <Col>
                            <img className="d-inline-block" src={HandsImg} alt="hand shake"
                        ...
                        <CardGroup className="text-center spacing">
                            <Card className="feature shadow-border spacing rounded mb-4">
                                <Card.Body>
                                    ...
                                    <Card.Text>Join Helping Hand today to help refugees. Set up your account to see
                                        refugees’ needs, accept new tasks, track your volunteer history, and receive
                                        special event notification.</Card.Text>
                                </Card.Body>
                            </Card>
                            <Card className="feature shadow-border spacing rounded mb-4">
                                <Card.Body>
                                    ...
                                    <Card.Text>Contribute to the community by accepting a task posted by refugees. Pick
                                        the one you are able to help, whether it is temporary accommodation, job
                                        opportunities, or clothes.</Card.Text>
                                </Card.Body>
                            </Card>
                            <Card className="feature shadow-border spacing rounded mb-4">
                                <Card.Body>
                                    ...
                                    <Card.Text>After completing each task, you will be awarded a certain amount of
                                        points. These points can be redeemed for volunteer hours or
                                        discounts.</Card.Text>
                                </Card.Body>
                            </Card>
                        </CardGroup>
                    ...
                    <Container className="home-refugees-content text-center bold">
                        ...
                        <Row className="mb-3">
                            ...
                            <Col className="home-ref-card light-purple-background" xs={12} md={5}>
                                ...
                                <Card.Text>Our volunteers can help with providing temorary accommodation, job
                                    opportunities, child care, household items, or food.</Card.Text>
                            </Col>
                        </Row>
                        ...
                        <Row className="mb-3">
                            <Col className="home-ref-card light-purple-background" xs={12} md={5}>
                                ...
                                <Card.Text>Express your needs by posting a ‘task card.’ Our volunteers can then see the
                                    tasks and accept one of them. You’ll be notified when there is a volunteer wanting
                                    to help you.</Card.Text>
                            </Col>
                        ...
                        <Row className="mb-3">
                            ...
                            <Col className="home-ref-card light-purple-background" xs={12} md={5}>
                                ...
                                <Card.Text>Rate the volunteers afterwards. Did they meet your expectations? Do you want
                                    to keep the connection in the future? You can also send a thank you card to your
