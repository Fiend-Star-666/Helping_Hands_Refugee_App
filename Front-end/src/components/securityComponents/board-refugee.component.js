                    ...
                    <div className="tasks">
                        ...
                        <Card className="task-content mb-4" style={{boxShadow: '5px 3px'}}>
                            <div className="task-description">
                                ...
                                <p>We are running a day care for all Ukrainian families. Give us a call for more
                                    info!</p>
                            </div>
                        </Card>
                        <Card className="task-content mb-4" style={{boxShadow: '5px 3px'}}>
                            <div className="task-description">
                                ...
                                <p>We have a large supply of household items and groceries for those in need. Come on by
                                    and grab what you need.</p>
                            </div>
                        </Card>
                    </div>
                    <footer></footer>
