...
class TempCreateRefugee extends React.Component {
    ...
    saveRefugee = (e) => {
        ...
        let refugee = {
            ...
            sizeOfGroup: this.state.sizeOfGroup,
    ...
    render() {
        return (
            ...
            // </div>
            <div className="card"
                 style={{height: "47rem", width: "45rem", margin: "auto", marginTop: "2rem", marginBottom: '2rem'}}>
                <div className="container" style={{width: "35rem", margin: "auto", marginTop: "2rem"}}>
                    ...
                    <Form id="refugee-form" onSubmit={this.saveRefugee}>
                        ...
                        <Form.Control name="streetAddress" value={this.state.streetAddress}
                                      onChange={this.changeHandler}/>
                        ...
                        <Row>
                            <Form.Group as={Col}>
                                ...
                                <Form.Control name="city" value={this.state.city} onChange={this.changeHandler}/>
                            </Form.Group>
                        ...
                        <Row>
                            <Form.Group as={Col}>
                                ...
                                <Form.Control name="sizeOfGroup" value={this.state.sizeOfGroup}
                                              onChange={this.changeHandler}/>
                            </Form.Group>
                            <Form.Group as={Col}>
                                <Form.Label className="ref-form-label">Adults</Form.Label>
                                <Form.Control name="numberOfAdults" value={this.state.numberOfAdults}
                                              onChange={this.changeHandler}/>
                            </Form.Group>
                            <Form.Group as={Col}>
                                <Form.Label className="ref-form-label">Children</Form.Label>
                                <Form.Control name="numberOfChildren" value={this.state.numberOfChildren}
                                              onChange={this.changeHandler}/>
                            </Form.Group>
                        </Row>
